...
var painting_material := 0 setget set_painting_material
...
func set_mesh_instance(to : MeshInstance) -> void:
	...
	yield(VisualServer, "frame_post_draw")
	set_painting_material(painting_material)


func set_painting_material(to : int) -> void:
	painting_material = to
	for material_num in mesh_instance.get_surface_material_count():
		if material_num == to:
			view_to_texture_mesh_instance.mesh.surface_set_material(material_num,
					preload("res://addons/painter/shaders/view_to_texture.material"))
			texture_to_view_mesh_instance.mesh.surface_set_material(material_num,
					preload("res://addons/painter/shaders/texture_to_view.material"))
		else:
			view_to_texture_mesh_instance.mesh.surface_set_material(material_num, null)
			texture_to_view_mesh_instance.mesh.surface_set_material(material_num, null)
